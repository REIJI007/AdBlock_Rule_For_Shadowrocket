# Title: AdBlock_Rule_For_Shadowrocket_RULE
# Description: 适用于Shadowrocket的域名拦截txt格式RULE规则，每20分钟更新一次，确保即时同步上游减少误杀
...
# 对规则进行排序并添加DOMAIN,前缀，并在每条规则后面加上",REJECT"后缀
...
$textContent = @"
# Title: AdBlock_Rule_For_Shadowrocket_RULE
# Description: 适用于Shadowrocket的域名拦截文本格式RULE规则，每20分钟更新一次，确保即时同步上游减少误杀
# Homepage: https://github.com/REIJI007/AdBlock_Rule_For_Shadowrocket
...
# 定义输出文件路径
$outputPath = "$PSScriptRoot/adblock_reject_shadowrocket_rule.txt"
